  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="serif text-7xl text-ink">404</h1>
        <p className="mt-2 text-sm text-muted-foreground">Nothing here.</p>
        <Link to="/" className="inline-block mt-6 underline">Home</Link>
      </div>
    </div>
  );
}
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="serif text-2xl text-ink">Something broke</h1>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Project HQ" },
      { name: "description", content: "Daily command center for thinking, posting, and follow-ups." },
    ],
    links: [
